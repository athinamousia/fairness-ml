...
Key findings from the exploratory data analysis reveal significant class imbalances in several categorical features (Gender, Debtor, Scholarship holder), right-skewed distributions in age and admission grades, and notable outliers in age at enrollment. These characteristics necessitate careful consideration in subsequent fairness analysis and bias mitigation strategies.